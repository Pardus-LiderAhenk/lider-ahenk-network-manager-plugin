...
import tr.org.liderahenk.networkmanager.dialogs.NetworkManagerProfileDialog;
...
/**
 * Profile definition handler for network-manager plugin.
 *
 */
public class NetworkManagerProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(NetworkManagerProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("NetworkManager"), NetworkManagerConstants.PLUGIN_NAME, 
					NetworkManagerConstants.PLUGIN_VERSION, new NetworkManagerProfileDialog()), 
