...
public class NetworkManagerProfileDialog implements IProfileDialog {
	
	private static final Logger logger = LoggerFactory.getLogger(NetworkManagerProfileDialog.class);
