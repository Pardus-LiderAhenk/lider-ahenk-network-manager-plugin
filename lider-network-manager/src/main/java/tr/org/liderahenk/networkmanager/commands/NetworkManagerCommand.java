package tr.org.liderahenk.networkmanager.commands;
...
public class NetworkManagerCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(NetworkManagerCommand.class);
